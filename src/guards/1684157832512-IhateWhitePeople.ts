...
export class IhateWhitePeople1684157832512 implements MigrationInterface {
    name = 'IhateWhitePeople1684157832512'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "ads" ("id" SERIAL NOT NULL, "slug" character varying NOT NULL, "subject" character varying NOT NULL, "title" character varying NOT NULL, "type" character varying NOT NULL, "hourlyRate" integer NOT NULL DEFAULT '0', "description" character varying NOT NULL DEFAULT '', "location" character varying NOT NULL DEFAULT '', "profilePicture" character varying NOT NULL, "lessonType" character varying NOT NULL DEFAULT '', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "tagList" text NOT NULL, "reccCount" integer NOT NULL DEFAULT '0', "studentNumber" integer NOT NULL DEFAULT '0', "authorId" integer, CONSTRAINT "PK_a7af7d1998037a97076f758fc23" PRIMARY KEY ("id"))`);
